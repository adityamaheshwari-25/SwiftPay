...
public interface KycDocumentService {
	KycDocumentUploadResponseDto uploadKyc(Authentication authetication, MultipartFile file) throws UserNotFoundException, FileNotUploadedException, LargerFileSizeException, InvalidFileTypeException, KycAlreadySubmittedException;
